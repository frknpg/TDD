package com.frknpg.hoaxify;

import com.frknpg.hoaxify.error.ApiError;
import com.frknpg.hoaxify.shared.GenericResponse;
import com.frknpg.hoaxify.user.User;
import com.frknpg.hoaxify.user.UserRepository;
...
public class UserControllerTest {
    ...
    @Test
    public void postUser_whenUserIsValid_user_SavedToDatabase() {
        User user = createValidUser();
    ...
    public void postUser_whenUserHasInvalidLengthUsername_receiveGenericMessageOfSizeError() {
        ...
        assertThat(validationErrors.get("username")).isEqualTo("It must have minumum 4 and maximum 255 characters");
    }
