...
describe('UserSignupPage', () => {
  ...
  describe('Interactions', () => {
    ...
    it('sets the password value into state', () => {
      const { queryByPlaceholderText } = render(<UserSignupPage />);
      const passworInput = queryByPlaceholderText('Your password');

      fireEvent.change(passworInput, changeEvent('P4ssword'));
      expect(passworInput).toHaveValue('P4ssword');
    });
    ...
    it('calls postSignup when the fields are valid and the actions are provided on props', () => {
      const actions = {
